let components = [
    //Hero Section
    {
        ...
        url: "https://flowbite.com/blocks/marketing/hero/#default-hero-section",
        content: 
    ...
    },
    {
        ...
        type: "full",
        section: "Hero Section",
        url: "https://flowbite.com/blocks/marketing/hero/#visual-image-with-heading",
        content: `
            <section class="bg-white dark:bg-gray-900">
    ...
    //Table Headers
    {
        name: "Default table header",
        type: "full",
        section: "Table Headers",
        url: "https://flowbite.com/blocks/application/table-headers/#default-table-header",
        content: `
    ...
    {
        name: 'Table header with text and button',
        type: 'full', 
        section: 'Table Headers', 
        url: 'https://flowbite.com/blocks/application/table-headers/#table-header-with-text-and-button',
        content: `
    ...
    //Side Navigations
    {
        name: 'Default hero section',
        type: 'left-half',  
        section: 'Side Navigations', 
        url: 'https://flowbite.com/blocks/application/sidenav/#default-side-navigation',
        content: `
    ...
    //Feature Sections
    {
        ...
        url: 'https://flowbite.com/blocks/marketing/feature/#default-feature-list',
        content: `
            <section class="bg-white dark:bg-gray-900">
    ...
    //CTA Sections
    {
        name: 'Default CTA section',
        type: 'left-half', 
        section: 'CTA Sections', 
        url: 'https://flowbite.com/blocks/marketing/cta/#default-cta-section',
        content: `
            <section class="bg-white dark:bg-gray-900">
                <div class="py-8 px-4 mx-auto max-w-screen-xl sm:py-16 lg:px-6">
    ...
    },
    {
        ...
        type: 'full',
        section: 'CTA Sections', 
        url: 'https://flowbite.com/blocks/marketing/cta/#image-with-cta-button',
        content: `
            <section class="bg-white dark:bg-gray-900">
    ...
    {
        name: 'Heading with CTA button',
        type: 'full', 
        section: 'CTA Sections', 
        url: 'https://flowbite.com/blocks/marketing/cta/#heading-with-cta-button',
        content: `
            <section class="bg-white dark:bg-gray-900">
                <div class="py-8 px-4 mx-auto max-w-screen-xl sm:py-16 lg:px-6">
    ...
    //Content Sections
    {
        name: 'Heading with description',
        type: 'full', 
        section: 'Content Sections', 
        url: 'https://flowbite.com/blocks/marketing/content/#heading-with-description',
        content: `
            <section class="bg-white dark:bg-gray-900">
    ...
    {
        name: 'Images with heading and description',
        type: 'full', 
        section: 'Content Sections', 
        url: 'https://flowbite.com/blocks/marketing/content/#images-with-heading-and-description',
        content: `
            <section class="bg-white dark:bg-gray-900">
    ...
    //Headers
    {
        name: 'Default header navigation',
        type: 'full', 
        section: 'Headers', 
        url: 'https://flowbite.com/blocks/marketing/header/#default-header-navigation',
        content: `
            <header>
    ...
    //Team Sections
    {
        ...
        url: 'https://flowbite.com/blocks/marketing/team/#team-member-cards',
        content: `
            <section class="bg-white dark:bg-gray-900">
                <div class="py-8 px-4 mx-auto max-w-screen-xl lg:py-16 lg:px-6 ">
    ...
    {
        name: 'Grid layout clean',
        type: 'full', 
        section: 'Team Sections', 
        url: 'https://flowbite.com/blocks/marketing/team/#grid-layout-clean',
        content: `
            <section class="bg-white dark:bg-gray-900">
    ...
    //Application Shells
    {
        name: 'Application shell with sidebar and navbar',
        type: 'full',
        section: 'Application Shells', 
        url: 'https://flowbite.com/blocks/application/shells/#application-shell-with-sidebar-and-navbar',
        content: `
    ...
    //Pricing Tables
    {
        name: 'Default pricing cards',
        type: 'full', 
        section: 'Pricing Tables', 
        url: 'https://flowbite.com/blocks/marketing/pricing/#default-pricing-cards',
        content: `
            <section class="bg-white dark:bg-gray-900">
                <div class="py-8 px-4 mx-auto max-w-screen-xl lg:py-16 lg:px-6">
    ...
    //Dashboard Footers
    {
        name: 'Default dashboard footer',
        type: 'full',  
        section: 'Dashboard Footers', 
        url: 'https://flowbite.com/blocks/application/dashboard-footer/#default-dashboard-footer',
        content: `
    ...
    //Advanced Tables
    {
        ...
        url: 'https://flowbite.com/blocks/application/advanced-tables/#default-table',
        content: `
    ...
    },
    {
        ...
        type: 'full', 
        section: 'Advanced Tables', 
        url: 'https://flowbite.com/blocks/application/advanced-tables/#table-with-products',
        content: `
    ...
    //Footer Sections
    {
        ...
        url: 'https://flowbite.com/blocks/marketing/footer/#default-footer-section',
        content: `
    ...
    {
        name: 'Sitemap with logo and social media',
        type: 'full',
        section: 'Footer Sections', 
        url: 'https://flowbite.com/blocks/marketing/footer/#sitemap-with-logo-and-social-media',
        content: `
    ...
    //Dashboard Navbars
    {
        name: 'Default navbar',
        type: 'full', 
        section: 'Dashboard Navbars', 
        url: 'https://flowbite.com/blocks/application/navbar/#default-navbar',
        content: `
            <header>
                <nav class="bg-white border-gray-200 px-4 lg:px-6 py-2.5 dark:bg-gray-800">
                    <div class="flex flex-wrap justify-between items-center">
    ...
    //Blog Templates
    {
        ...
        type: 'full',
        section: 'Blog Templates', 
        url: 'https://flowbite.com/blocks/publisher/blog-templates/#default-blog-template',
        content: `
            <!-- 
    ...
    //Read Sections (CRUD)
    {
        name: 'Default read section',
        type: 'full',
        section: 'Read Sections (CRUD)', 
        url: 'https://flowbite.com/blocks/application/crud-read-sections/#default-read-section',
        content: `
            <section class="bg-white dark:bg-gray-900">
    ...
    //CRUD Layouts
    {
        name: 'Default CRUD layout',
        type: 'full',
        section: 'CRUD Layouts', 
        url: 'https://flowbite.com/blocks/application/crud/#default-crud-layout',
        content: `
        <!-- Start block -->
    ...
    //Table Footers
    {
        name: 'Default table footer with pagination',
        type: 'full',
        section: 'Table Footers', 
        url: 'https://flowbite.com/blocks/application/table-footers/#default-table-footer-with-pagination',
        content: `
            <section class="flex items-center h-screen bg-gray-50 dark:bg-gray-900">
                <div class="w-full max-w-screen-xl px-4 mx-auto lg:px-12">
                <!-- Start coding here -->
    ...
    //Contact Forms
    {
        ...
        url: 'https://flowbite.com/blocks/marketing/contact/#default-contact-form',
        content: `
            <section class="bg-white dark:bg-gray-900">
    ...
    //Login Forms
    {
        ...
        type: 'full',
        section: 'Login Forms', 
        url: 'https://flowbite.com/blocks/marketing/login/#default-login-page',
        content: `
    ...
    //Account Recovery 
    {
        name: 'Default forgot password page',
        type: 'full',
        section: 'Account Recovery', 
        url: 'https://flowbite.com/blocks/marketing/account-recovery/#default-forgot-password-page',
        content: `
            <section class="bg-gray-50 dark:bg-gray-900">
                <div class="flex flex-col items-center justify-center px-6 py-8 mx-auto md:h-screen lg:py-0">
                    <a href="#" class="flex items-center mb-6 text-2xl font-semibold text-gray-900 dark:text-white">
    ...
    //Blog Sections
    {
        ...
        url: 'https://flowbite.com/blocks/marketing/blog/#default-blog-card',
        content: `
        <section class="bg-white dark:bg-gray-900">
        <div class="py-8 px-4 mx-auto max-w-screen-xl lg:py-16 lg:px-6">
    ...
    //Project Portfolio
    {
        name: 'Default portfolio example',
        type: 'full', 
        section: 'Project Portfolio', 
        url: 'https://flowbite.com/blocks/marketing/portfolio/#default-portfolio-example',
        content: `
    ...
    //Comments Sections
    {
        ...
        url: 'https://flowbite.com/blocks/publisher/comments/#default-comments-list',
        content: `
    ...
    //404 Pages
    {
        ...
        type: 'full', 
        section: '404 Pages', 
        url: 'https://flowbite.com/blocks/marketing/404/#default-example',
        content: 
            (<section class="bg-white dark:bg-gray-900">
                <div class="py-8 px-4 mx-auto max-w-screen-xl lg:py-16 lg:px-6">
                    <div class="mx-auto max-w-screen-sm text-center">
